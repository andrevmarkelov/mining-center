...
return [
    ...
    'supportedLocales' => [
        'ru' => ['name' => 'Russian', 'script' => 'Cyrl', 'native' => 'Русский', 'regional' => 'ru_RU', 'flag_class' => 'flag-icon flag-icon-ru'],
        'en' => ['name' => 'English', 'script' => 'Latn', 'native' => 'English', 'regional' => 'en_US', 'flag_class' => 'flag-icon flag-icon-gb'],
    ],
