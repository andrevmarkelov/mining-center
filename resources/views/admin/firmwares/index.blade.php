        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Список прошивок</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.firmwares.create') }}"><i class="fas fa-plus"></i> Добавить</a>
                    </div>
                </div>
                <div class="card-body">
...
@section('script')
    ...
    <script>
        dTSettings = Object.assign(dTSettings, {
            processing: true,
            serverSide: true,
            ajax: "{!! route('admin.firmwares.index', request()->getQueryString()) !!}",
            columns: [
                {
                    data: 'thumb',
