            ...
            @foreach($langs as $key => $item)
                ...
                <div class="tab-pane {{ key($langs) == $key ? 'active' : '' }}" id="tab-{{ $key }}">
                    <div class="form-group">
                        ...
                        <input name="{{ $key }}[title]" value="{{ old($key . '.title', $news_category->title ?? '') }}" type="text" id="{{ $key }}_input-title" class="form-control">
                    </div>
                    <div class="form-group">
                        <label for="{{ $key }}_input-meta_h1">H1 ({{ $key }})</label>
                        <input
                            name="{{ $key }}[meta_h1]"
                            value="{{ $news_category->meta_h1 ?? '' }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            data-height="85">{{ $news_category->subtitle ?? '' }}</textarea>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            class="form-control js-summernote">{{ old($key . '.description', $news_category->description ?? '') }}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea
                            ...
                            class="form-control">{{ $news_category->meta_description ?? '' }}</textarea>
                    </div>
                </div>
            @endforeach
...
{{--                    'value' => $news_category->image ?? null--}}
{{--                ])--}}
...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input name="alias" value="{{ old('alias', $news_category->alias ?? '') }}" type="text" id="input-alias" class="form-control">
        ...
        <div class="form-group">
            ...
            <div>
                ...
                <input name="status" value="1" type="checkbox" id="input-status" data-bootstrap-switch
                       @if(old('status', $news_category->status ?? true))
                       checked
                    @endif
                >
            </div>
        ...
        <div class="form-group d-none">
            ...
            <div>
                ...
                <input name="sitemap" value="1" type="checkbox" id="input-sitemap" data-bootstrap-switch
                       @if(old('sitemap', $news_category->sitemap ?? true))
                       checked
                    @endif
                >
            </div>
