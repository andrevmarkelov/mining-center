        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Список дата центров</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.data_centers.create') }}"><i class="fas fa-plus"></i> Добавить</a>
                    </div>
                </div>
                <div class="card-body">
...
@section('script')
    ...
    <script>
        dTSettings = Object.assign(dTSettings, {
            processing: true,
            serverSide: true,
            ajax: "{!! route('admin.data_centers.index', request()->getQueryString()) !!}",
            columns: [
                {
                    data: 'thumb',
