                ...
                var Editor_Editor = /*#__PURE__*/ (function () {
                    function Editor(context) {
                        ...
                        this.createLink = this.wrapCommand(function (linkInfo) {
                            ...
                            var isTagNofollow = linkInfo.isTagNofollow; // my custom
                        ...
                        },
                        {
                            ...
                            value: function getLinkInfo() {
                                ...
                                if ($anchor.length) {
                                    ...
                                    linkInfo.isTagNofollow = $anchor.attr("rel") === "nofollow"; // my custom
                                }
                                    ...
                                    !this.options.disableLinkTarget
                                        ? external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()(
                                              ...
                                              .append(
                                                this.ui
                                                    .checkbox({
                                                        className: "sn-checkbox-add-tag-nofollow",
                                                        text: 'Добавить атрибут rel="nofollow"',
                                                        checked: false,
                                                    })
                                                    .render()
                                              )
                            ...
                            value: function showLinkDialog(linkInfo) {
                                ...
                                return external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default.a
                                    .Deferred(function (deferred) {
                                        ...
                                        var $addTagNofollow =
                                            _this.$dialog.find(
                                                ".sn-checkbox-add-tag-nofollow input[type=checkbox]"
                                            );
                                        // end
